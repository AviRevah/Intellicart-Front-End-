    ...
    <Card>
      ...
      <CardBody>
          ...
          <GridItem xs={12} sm={12} md={3}>
            ...
            <Button color="primary">Branch 1</Button>
             {/* <CustomInput 
                    labelText= {e.timer}
                    id="timer"
                    formControlProps={{
          ...
          <GridItem xs={12} sm={12} md={3}>
            ...
            <Button color="primary">Branch 2</Button>
             {/* <CustomInput 
                    labelText= {e.timer}
                    id="timer"
                    formControlProps={{
          ...
          <GridItem xs={12} sm={12} md={3}>
            ...
            <Button color="primary">Branch 3</Button>
             {/* <CustomInput 
                    labelText= {e.timer}
                    id="timer"
                    formControlProps={{
          ...
          <Button color="primary">Branch 4</Button>
           {/* <CustomInput 
                  labelText= {e.timer}
                  id="timer"
                  formControlProps={{
        ...
        <GridItem xs={12} sm={12} md={3}>
          ...
          <Button color="primary">Branch 5</Button>
           {/* <CustomInput 
                  labelText= {e.timer}
                  id="timer"
                  formControlProps={{
